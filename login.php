<?php
    ...
    //como sólo puede haber como mucho un DNI en este resultado porque el DNI es campo clave
    //y no se puede repetir, lo pongo con un if; si no, se tiene que tratar todo el resultado de 
    //la query con un bucle for por ejemplo
    if ($numero_dnis > 0) {
